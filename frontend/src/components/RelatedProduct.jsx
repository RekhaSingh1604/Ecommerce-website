...
const RelatedProduct = ({ category, subCategory }) => {
  ...
  useEffect(() => {
    if (products.lenght > 0) {
      ...
      productCopy = productCopy.fiter((item) => category === item.category);
      productCopy = productCopy.fiter((item) => subCategory === item.subCategory);
  ...
  return (
    <div className="my-24">
      <div className="text-center text-3xl py-2">
        <Tittle text1={"RELETED"} text2={"PRODUCTS"} />
      </div>
